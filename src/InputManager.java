...
public class InputManager
{
 ...
 String addAdmin="ADD ADMIN [a-zA-Z]+ \\w{8,}\\s*";
 String addUser="ADD USER [a-zA-Z]+ \\w{8,}\\s*";
 String loginAdmin="LOGIN ADMIN [a-zA-Z]+ \\w{8,}\\s*";
 String loginUser="LOGIN USER [a-zA-Z]+ \\w{8,}\\s*";
